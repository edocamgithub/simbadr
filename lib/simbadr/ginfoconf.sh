...
echo ""
echo '   <deviceUPS status="0" content="image/gif" description="Conected UPS status icon">ups0.png</devicetUPS>'
echo '   <deviceUPS status="1" content="image/gif" description="GIF Animation 100% UPS status icon">ups1.gif</deviceUPS>'
echo '   <deviceUPS status="2" content="image/gif" description="Conected 80% UPS status icon">ups2.png</deviceUPS>'
echo '   <deviceUPS status="3" content="image/gif" description="GIF Animation 80% UPS status icon">ups2.gif</deviceUPS>'
echo '   <deviceUPS status="4" content="image/gif" description="Conected 60% UPS status icon">ups3.png</deviceUPS>'
echo '   <deviceUPS status="5" content="image/gif" description="GIF Animation 60% UPS status icon">ups3.gif</deviceUPS>'
echo '   <deviceUPS status="6" content="image/gif" description="Conected 40% UPS status icon">ups4.png</deviceUPS>'
echo '   <deviceUPS status="7" content="image/gif" description="GIF Animation 40% UPS status icon">ups4.gif</deviceUPS>'
echo '   <deviceUPS status="8" content="image/gif" description="Conected 20% UPS status icon">ups5.png</deviceUPS>'
echo '   <deviceUPS status="9" content="image/gif" description="GIF Animation 20% UPS status icon">ups5.gif</deviceUPS>'
echo ""
echo '   <hostFw status="0" content="image/gif" description="Conected Firewall status icon">firewall.png</hostFw>'
echo '   <hostFw status="1" content="image/gif" description="GIF Animation Firewall status icon">firewall.gif</hostFw>'	
echo '   <hostFw status="2" content="image/gif" description="Configuration 80% Firewall status icon">firewall2.png</hostFw>'
echo '   <hostFw status="3" content="image/gif" description="Configuration 30% Firewall status icon">firewall3.png</hostFw>'	
echo ""
echo '   <systemFlow status="0" content="image/gif" description="System status icon">sys0.png</systemFlow>'
echo '   <systemFlow status="1" content="image/gif" description="GIF Animation System status icon">sys0.gif</systemFlow>'	
echo ""
echo '   <deviceAp status="0" content="image/gif" description="Disconcted AP status icon">antena1.png</deviceAp>'
echo '   <deviceAp status="1" content="image/gif" description="GIF Animation Conected AP status icon">antena1.gif</deviceAp>'
echo '   <deviceAp status="2" content="image/gif" description="Conected AP status icon">antena1_0.png</deviceAp>'	
echo ""
echo "</imageStandard>"
